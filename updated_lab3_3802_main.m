...
data2412 = readmatrix('NACA_2412_digitized.xlsx');
ExperimentalAoA_2412 = data2412(:,1);
cl_experimental_2412 = data2412(:,2);
plot(ExperimentalAoA_2412,cl_experimental_2412);

data4412 = readmatrix('NACA_4412_digitized.xlsx'); % The data we need is actually in 3 and 4 not 1 and 2. Same for 4412!!!
ExperimentalAoA_4412 = data4412(:,3);
cl_experimental_4412 = data4412(:,4);
